...
import { idlFactory } from './biodex.did.js';
export { idlFactory } from './biodex.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BIODEX_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./biodex.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the biodex canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./biodex.did.js")._SERVICE>}
 */
export const biodex = createActor(canisterId);
